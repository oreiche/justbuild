...
install: justbuild $(MANPAGES)
	...
	install -D $(BUILDDIR)/share/man/just-lock.1 $(DESTDIR)/$(PREFIX)/share/man/man1/just-lock.1
	...
	install -D $(BUILDDIR)/share/man/just-lock-config.5 $(DESTDIR)/$(PREFIX)/share/man/man5/just-lock-config.5
